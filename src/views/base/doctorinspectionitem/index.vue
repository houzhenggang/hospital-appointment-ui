...
<script>
    import {fetchList, getObj, addObj, putObj, delObj} from '@/api/base/doctorinspectionitem'
    import {tableOption} from '@/const/crud/base/doctorinspectionitem'
    import {mapGetters} from 'vuex'

    export default {
        name: 'doctorinspectionitem',
        data() {
            return {
                searchForm: {},
                tableData: [],
